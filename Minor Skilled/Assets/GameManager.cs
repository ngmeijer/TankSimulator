...
public class GameManager : SingletonMonobehaviour<GameManager>
{
    ...
    {
        Debug.Assert(_player != null, $"Player reference in GameManager ({gameObject.name}) is null. Drag into the inspector");
        Debug.Assert(_spawnedShellsParent != null, $"SpawnedShellsParent reference in GameManager ({gameObject.name}) is null. Drag into the inspector");
        Debug.Assert(_vfxParent != null, $"VFXParent reference in GameManager ({gameObject.name}) is null. Drag into the inspector");
    }
